# Execution flow for schema 'Billing'
...
- procedure 'usp_AddNewAgency' in schema 'Billing'
...
- procedure 'usp_AddNewAgency' in schema 'Billing' can trigger:
  - procedure 'usp_AddAgencyFundingGroup' in schema 'Billing' (in this diagram, this procedure does not trigger any other recorded procedures)