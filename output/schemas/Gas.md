...
- procedure 'usp_ProcessCommonElectronicGasUnknownExchangeDataByCursor' in schema 'Gas'
...
- procedure 'usp_ProcessCommonElectronicGasUnknownExchangeDataByCursor' in schema 'Gas' can trigger:
  - procedure 'usp_ProcessCommonElectronicGasUnknownExchangeCode' in schema 'Gas' (in this diagram, this procedure does not trigger any other recorded procedures)